 ...
 */
public class EvaluatePostFragment extends Fragment implements AdapterView.OnItemSelectedListener,
    ...
    public void onDestroy() {
        super.onDestroy();
        // 返回时 收回软键盘
        View viewFocus = requireActivity().getCurrentFocus();
        if (viewFocus != null) {
            InputMethodManager imManager = (InputMethodManager)requireActivity().getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    private void initView() {
        // spinner
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(requireContext(), R.array.evaluate_post, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        binding.spinnerHall.setAdapter(adapter);
        binding.spinnerHall.setOnItemSelectedListener(this);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        EvaluatePostDto evaluate = viewModel.getEvaluate().getValue();
        evaluate.setHallId(position);
        viewModel.getEvaluate().setValue(evaluate);
    }
    ...
    public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
        binding.evaluateScore.setText(String.valueOf(rating));
        EvaluatePostDto evaluate = viewModel.getEvaluate().getValue();
        evaluate.setEvaluateScore(rating);
        viewModel.getEvaluate().setValue(evaluate);
        //Log.d(AppConfig.TEST_TAG, "onRatingChanged: " + viewModel.getEvaluate().getValue().toString());
    }
    ...
    private void handlePhoto(boolean flag) {
        ...
        viewModel.getImage().setValue(file);

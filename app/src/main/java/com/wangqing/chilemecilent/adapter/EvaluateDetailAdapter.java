...
public class EvaluateDetailAdapter extends RecyclerView.Adapter<FoodRecDetailAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull FoodRecDetailAdapter.ViewHolder holder, int position) {
